  ...
  return (
    <main className="container py-4">
      ...
      <div className="card my-3">
        <div className="card-body">
          <h2 className="card-title">Project: {project.name}</h2>
          <p>
            Description:{" "}
            {project?.description
              ? project.description
              : "This project doesn't have any description."}
          </p>
        </div>
      </div>
            ...
            <table className="table table-striped table-bordered">
              <thead>
                <tr>
                  ...
                  <th>PRIORITY</th>
                  <th className="d-none d-lg-table-cell">DUE ON</th>
                  <th className="d-none d-xl-table-cell">DAYS TO CLOSE</th>
                  <th>STATUS</th>
                </tr>
              </thead>
              <tbody>
                {sortViaPriority.map((task, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      ...
                      <small className="d-md-none text-muted d-block">
                        Owner: {task.name}
                      </small>
                      <small className="d-lg-none d-md-block text-muted">
                        Due: {task?.dueDate.split("T")[0]}
                      </small>
                      <small className="d-xl-none d-lg-block text-muted">
                        Days: {task.timeToComplete}
                      </small>
                    </td>
                    <td className="d-none d-md-table-cell">{task.name}</td>
                    <td>
                      <span
                        className={`badge ${
                          task?.priority === "High"
